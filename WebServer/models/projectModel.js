...
exports.createProject = async (projectName, startDate, endDate, ownerId, personnel) => {
  const result = await db.query('INSERT INTO projects (projectName, startDate, endDate, ownerId, personnel) VALUES (?, ?, ?, ?, ?)', [projectName, startDate, endDate, ownerId, personnel]);
